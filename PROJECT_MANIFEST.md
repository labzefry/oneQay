...
Published bounded Platform Foundation work through Sprint 12 and Sprint 13 is preserved separately from this unresolved Technical Preview decision package and does not promote any item in this package except where a later explicit substantive decision, such as DEC-002, DEC-003, DEC-005, DEC-006, or DEC-007, independently changes that item's status.
...
- No final/business/production implementation, Android project/source, database/schema/SQL/migration implementation, authentication implementation, payment/provider/manual-tender implementation, package/dependency installation, real-money processing, offline semantics, deployment, release, SQL execution, migration execution, or production database modification is authorized by GOV-051, DEC-000, DEC-001, DEC-002, DEC-003, DEC-004, DEC-005, DEC-006, or DEC-007.
