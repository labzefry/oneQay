...
// Author by Lab | zefry
final class PosShiftStartWorkspaceServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        $this->app->scoped(PosShiftStartWorkspaceRepository::class, function ($app): PosShiftStartWorkspaceRepository {
            /** @var Connection $connection */
            $connection = $app->make('db')->connection();

            return new LaravelPosShiftStartWorkspaceRepository(
                $connection,
        ...
        $this->app->scoped(ViewPosShiftStartWorkspace::class, fn ($app): ViewPosShiftStartWorkspace => new ViewPosShiftStartWorkspace(
            $app->make(PosShiftStartWorkspaceRepository::class),
