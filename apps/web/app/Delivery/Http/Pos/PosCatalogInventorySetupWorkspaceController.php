...
// Author by Lab | zefry
final class PosCatalogInventorySetupWorkspaceController
{
    public function __construct(private readonly ViewPosCatalogInventorySetupWorkspace $workspace) {}
    ...
    public function __invoke(Request $request): Response|JsonResponse
    {
        ...
        try {
            ...
            return Inertia::render('Pos/CatalogInventorySetup', [
                'scope' => [
                ...
                'endpoints' => [
                    'catalog_prepare' => route('pos.catalog.prepare'),
                    'inventory_baseline' => route('pos.inventory.baseline'),
                ],
            ...
            return response()->json(
                SafeErrorEnvelope::make('POS_CATALOG_INVENTORY_SETUP_AUTHORIZATION_DENIED', $correlationId),
                403,
                ['Cache-Control' => 'no-store, private'],
            );
        } catch (PosTransactionViolation) {
            return response()->json(
                SafeErrorEnvelope::make('POS_CATALOG_INVENTORY_SETUP_UNAVAILABLE', $correlationId),
                503,
                ['Cache-Control' => 'no-store, private'],
            );
        }
