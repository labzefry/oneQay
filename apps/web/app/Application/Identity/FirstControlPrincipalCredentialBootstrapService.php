...
final readonly class FirstControlPrincipalCredentialBootstrapService
{
    ...
    public function bootstrap(
        ...
        // Keep deterministic, read-only denial reasons outside the historical
        // PersistenceTransaction callback. The durable adapter repeats every
        // critical check inside the transaction immediately before insertion.
