...
final class PosPermission
{
    ...
    public const RECORD_CASH_VARIANCE_REVIEW_DECISION = 'pos.shift.cash-variance-review-decision.record';
    ...
    public static function recordCashVarianceReviewDecision(): PermissionIdentifier
    {
        return PermissionIdentifier::fromString(self::RECORD_CASH_VARIANCE_REVIEW_DECISION);
    }
