...
// Author by Lab | zefry
final readonly class EstablishInventoryBaseline
{
    private const IDENTIFIER_PATTERN = '/\A[A-Za-z0-9][A-Za-z0-9._:-]{7,127}\z/';

    public function __construct(
        private InventoryBaselineRepository $inventory,
        ...
        private InventoryBaselineClock $clock,
    ) {}
    ...
    public function establish(
        ...
        return $this->transaction->run(
            fn (): InventoryBaselineResult => $this->inventory->establish(
                $context,
                $command,
                $correlationId,
                $occurredAtUnix,
