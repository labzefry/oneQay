...
// Author by Lab | zefry
final readonly class ViewPosShiftHistoryPerformanceWorkspace
{
    private const VIEW_PERMISSION = 'pos.reporting.sales-summary.view';

    public function __construct(
        private PosShiftHistoryPerformanceWorkspaceRepository $reports,
        private OrganizationalContextStore $contexts,
        private DurableScopedAuthorizationPolicy $authorization,
    ) {}

    public function view(?string $selectedShiftId): PosShiftHistoryPerformanceWorkspaceSnapshot
    {
        ...
        return $this->reports->read($context, $selectedShiftId);
    }
}
