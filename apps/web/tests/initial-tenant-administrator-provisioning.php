...
sort($s23Actual);
$assert($s23Actual === $s23Migrations, 'Sprint 23 preservation requires exact eight-migration set through Sprint 28.');
...
$assert($s23Connection->getSchemaBuilder()->hasTable('oneqay_initial_password_enrollments'), 'Sprint 28 enrollment table missing during Sprint 23 preservation.');
